      ...
      <div className="relative z-10 ">
          <h1 className="text-blue-900 text-3xl font-semibold text-center">О компании</h1>
            ...
            <div className="container font-semibold  mx-auto px-4">
                ...
                <p>- Мы предлагаем широкий выбор медицинского оборудования для аренды, включая специальные матрасы, Кресла для людей с дополнительными потребностями, пульсоксиметры, СИПАП аппараты и кислородные концентраторы и многое другое.</p>
