        ...
        <div>
            ...
            <div className="grid  sm:grid-cols-3 grid-cols-1 gap-4 flex text-black  ">
                ...
                <div className="bg-transparent w-auto h-auto p-4 border rounded shadow hover:border-2 hover:border-blue-500 transition duration-200 ">
                    ...
                    <h2 className="text-xl font-bold mb-2 text-black">Костыли с устройством против скольжения</h2>
                ...
                <div className="p-4 border rounded shadow hover:border-2 hover:border-blue-500 transition duration-200">
                    ...
                    <h2 className="text-xl font-bold mb-2 text-black">Костыли металлические</h2>
                ...
                <div className="p-4 border rounded shadow hover:border-2 hover:border-blue-500 transition duration-200">
                    ...
                    <h2 className="text-xl font-bold mb-2 text-black">Костыли локевые</h2>
                    <p className="text-gray-600"><b>Продажа:</b> 2 490 ₽  </p>
                    <p className="text-gray-600"><b>Прокат:</b> 490 ₽ \ месяц</p>
                </div>
                <div className="p-4 border rounded shadow hover:border-2 hover:border-blue-500 transition duration-200">
                    <Image src={hmain} width="200" height="200" alt="Ходунки складные"    ></Image>
                    <h2 className="text-xl font-bold mb-2 text-black">Ходунки складные</h2>
                ...
                <div className="p-4 border rounded shadow hover:border-2 hover:border-blue-500 transition duration-200">
                    ...
                    <h2 className="text-xl font-bold mb-2 text-black">Ходунки складные на колесах</h2>
